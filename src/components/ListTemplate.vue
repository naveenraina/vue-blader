<template>
    <div>
        ...
        <div class="d-flex">
            <div v-if="isAddTemplate == false" class="ml-3" @click="isAddTemplate = true; inputText = ''">
            ...
            <!-- <button class="btn btn-primary" @click="isAddTemplate = false "> -->
                <svg @click="isAddTemplate = false " class="bi bi-x ml-1 mt-2" width="1.4em" height="1.4em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
